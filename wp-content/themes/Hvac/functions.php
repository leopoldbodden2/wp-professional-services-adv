...
define( 'VENDOR', TEMPPATH. "/assets/vendor");
...
register_sidebar( array(
	...
	'id'            => 'custom-navbar-right-alt-widget',
	'before_widget' => '',
	'after_widget'  => '',
...
register_sidebar( array(
	'name'          => 'Header Bottom',
	'id'            => 'custom-header-bottom-widget',
	'before_widget' => '',
	'after_widget'  => '',
	'before_title'  => '',
	'after_title'   => '',
...
add_action('get_footer', 'drv_add_css_head');
// add css when logged in to push site down for admin-bar
function drv_add_css_head()
{
