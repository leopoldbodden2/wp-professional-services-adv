<section id="callouts" class="row">
    <div class="container">
		 ...
		 */
		if(file_exists(get_template_directory().'/assets/images/callouts')) {
			$files = array();
			$order = 0;
			foreach (new RecursiveDirectoryIterator(get_template_directory() . '/assets/images/callouts', FilesystemIterator::SKIP_DOTS) as $file) {
				$order++;
				...
				foreach ($files as $file) {
                    ...
                    <li>
                        <img alt="<?= $file[2]; ?>"
                             ...
                             data-src="<?= IMAGES; ?>/callouts/<?= $file[1] ?>"
